...
class celeb_reid_light(ImageDataset):
    ...
    def __init__(self, cfg):
        ...
        super(celeb_reid_light, self).__init__(train, query, gallery)
    ...
    def process_dir(self, dir_path, mode, relabel=False):
        ...
        for img_path in img_paths:
            pid, _, _ = pattern.search(img_path).groups()
            pid = pid.split('/')[-1]
        ...
        for img_path in img_paths:
            pids, camid, _ = pattern.search(img_path).groups()
