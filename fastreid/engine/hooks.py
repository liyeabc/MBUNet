...
class CallbackHook(HookBase):
    """
    Create a hook using callback functions provided by the user.使用用户提供的回调函数创建一个钩子。
    """

    def __init__(self, *, before_train=None, after_train=None, before_step=None, after_step=None):
        """
        Each argument is a function that takes one argument: the trainer.每个参数都是接受一个参数的函数:trainer
        """
